...
#########################
"""
Admin1 = B_Admin.query.filter_by(A_id="A1").first()
print(Admin1.A_pass)

Dues=Charge_Details.query.filter_by(Status="due").first()
"""




from tables import db, B_Admin,B_Customer
...
cust = B_Customer.query.with_entities(B_Customer.C_id)
m=list(cust)
print(m)
